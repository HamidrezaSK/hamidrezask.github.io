...
layout: post
---
Designed a compiler plugin (LLVM) to improve the throughput of SIMD operations. This plugin is specifically designed to work with custom CPU design implemented on FPGAs. [Github Repository](https://github.com/HamidrezaSK/llvm_bithaa)
